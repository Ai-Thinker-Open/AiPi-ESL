...
AT_ctx_t mAT_Ctx_def =
{
    ...
    .mod_name        = "ESL-01",
    .mac_addr        = {0x06,0x06,0x06,0x06,0x06,0x06},
    .mod_pin         = "000001",
    .rfpw            = 0,  // 4dBm
    .pw_mod          = 2,  // power save mode.
    ...
    .auto_slp_time   = 5,      // auto sleep timeout
};
...
uint16_t at_test(uint32_t argc, uint8_t* argv[]);
